...
- **Volume & Akumulasi** — deteksi pola "akumulasi post-ARA lalu siap terbang" (versi bandar): ARA (+10% harian) = puncak distribusi/dump, lalu semua hari sejak ARA dihitung — kepadatan hari RVOL ≥ 2.0× minimal 40% (min 2 hari) + harga **masih di bawah level ARA** (belum recovery) + harga **di atas SMA20** → badge "Siap Terbang". Divalidasi walk-forward (963 saham IDX, 2026): pada sub-arm yang masih di bawah ARA, P(boom +10% dalam 5 hari) naik 5.9% (kontrol) → 16.8% (pola, n=2958), pump 5% 26.5% → 34.0%; fresh cross SMA20 (≤2 hari) justru lebih lemah (36.4%) daripada posisi sudah di atas (51.9%). Saham yang sudah recovery/distribusi di atas ARA (mis. ARGO +30%) sengaja TIDAK disinyal — sinyal hanya untuk yang masih "merah". Kasus nyata: SOLA 30 Jul–5 Ags (volume 10–25M, harga turun 104→88) lalu 6 Ags melesat +14.5% dengan 147M.

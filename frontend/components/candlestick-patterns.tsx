          ...
          return (
            <div key={i} className={`rounded-xl border ${signalCls.border} ${signalCls.bg} p-4 transition-all hover:shadow-md`}>
              ...
              <div className="flex items-start gap-3 mb-3">
                {/* SVG Illustration */}
                <div className="flex-shrink-0 p-2 rounded-lg bg-[var(--color-surface)]/70 border border-[var(--color-border)] shadow-sm">
              ...
              {/* Prediction */}
              <div className="p-2.5 rounded-lg bg-[var(--color-surface)]/50 border border-[var(--color-border)] mb-2">
